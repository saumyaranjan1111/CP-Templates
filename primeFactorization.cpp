...
void _printpll(vector<pll> &arr){for(auto &x:arr){cout<<x.first<<" "<<x.second<<endl;}}
...
void solve(){
    // list down the prime factorization of a number n
    ll n; cin>>n;
    vector<pair<ll, ll>> ans = factorize(n);
    _printpll(ans);
}
